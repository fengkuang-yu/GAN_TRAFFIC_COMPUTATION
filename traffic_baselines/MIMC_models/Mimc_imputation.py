...
logging.basicConfig(format='%(asctime)s %(message)s',
                    ...
                    filename='Mimc_model_result.log',
                    level=logging.ERROR)
...
class mimc_imputation():
    def __init__(self, missing_percentage=0.8, test_percent=0.15,
        ...
        # 构建模型
        self.attention_model = self.mimc_imputation_model()
    
    def mimc_imputation_model(self):
...
if __name__ == '__main__':
    ...
    def basic_task(miss_percent=0.1):
        ...
        for miss_mode in ['patch', 'spatial_line', 'temporal_line']:
            ae = mimc_imputation(missing_percentage=miss_percent, test_percent=0.15, miss_mode=miss_mode)
